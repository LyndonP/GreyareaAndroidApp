...
public class ShowMovies extends AppCompatActivity {
    ...
    // logging activities
    private static final String TAG = "MoviesDisplay";

    private ArrayList<String> movie_titles = new ArrayList<>();
    private ArrayList<String> movie_img_url = new ArrayList<>();
    private ArrayList<String> movie_year = new ArrayList<>();
    private ArrayList<String> movie_director = new ArrayList<>();
    private ArrayList<String> movie_description = new ArrayList<>();
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        if(item.getItemId() == R.id.action_setting){
            Toast.makeText(ShowMovies.this,
                    "Settings Clicked",
    ...
    private void initRecyclerView(){
        ...
        RecyclerAdapter adapter = new RecyclerAdapter(movie_titles, movie_img_url, movie_year, movie_director, movie_description, this);
